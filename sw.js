...
const CACHE = 'p2s-guide-v4.2.42-702792a3';
...
const OPTIONAL = ['./manifest.webmanifest', './icon-192.png',
  './icon-512.png', './icon-512-maskable.png', './apple-touch-icon.png', './favicon-32.png', './fflate.min.js', './builder.js', './gate.js', './export3mf.js', './preview.js', './projekt-ui.js', './spec-v1.schema.json', './przerobka-web.js', './przerobka-ui.js', './intent.js', './modele_guard.js', './modele-rura.js', './szukaj.js', './nitka.js', './spec-validate.js', './font-skrypt.js', './studio.css', './studio.js', './analizator-3mf.js', './analizator-profile.js', './analizator-profile.json', './wyszukiwanie.js', './wektory-przewodnik.json', './ocena-zdjecia.js', './ocena-zdjecia.json', './drukarka-status.js', './wizja-projekt.js', './brep-cechy.js', './modele/LICENSE-ocena-zdjecia.txt', './wersja.json', './pliki.json', './sw.js', './vendor/ort/LICENSE-onnxruntime-web.txt'];
