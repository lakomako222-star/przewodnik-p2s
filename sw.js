...
const CACHE = 'p2s-guide-v4.2.33-61c83147';
...
const OPTIONAL = ['./manifest.webmanifest', './icon-192.png',
  './icon-512.png', './icon-512-maskable.png', './apple-touch-icon.png', './favicon-32.png', './fflate.min.js', './builder.js', './gate.js', './export3mf.js', './preview.js', './projekt-ui.js', './spec-v1.schema.json', './przerobka-web.js', './przerobka-ui.js', './intent.js', './szukaj.js', './nitka.js', './spec-validate.js', './font-skrypt.js', './studio.css', './studio.js', './wersja.json', './pliki.json', './sw.js'];
